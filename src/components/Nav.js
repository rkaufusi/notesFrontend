...
const Nav = () => {
	...
	const handleDelete = async () => {
		...
		console.log(' here is my token' + userToken)
		await axios.delete('http://localhost:3500/delete', {params: { 
			token: userToken 
		}});
	...
	return (
		<div className="flex justify-end bg-slate-300 h-12 w-full">
			...
			<button onClick={handleDelete} className="px-3 m-1 mr-2 text-xl bg-red-600 rounded-lg text-white">Delete User</button>
		</div>
	)
}
